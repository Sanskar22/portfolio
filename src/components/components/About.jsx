...
const About = () => {
  return (
    <>
      ...
      max-w-3xl leadind-[30px]"
      >
        I'm skilled web developer with experience in Typescript ans Javascript,
        ans React JS. I'm quick learner and collaborate colsely with clients to
